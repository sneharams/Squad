...
<?php
    ...
    if(isset($_GET['squad']) && isset($_GET['username']) && isset($_GET['time']) && isset($_GET['date'])  && isset($_GET['end_time']) && isset($_GET['event'])){
        newUser($_GET['squad'], $_GET['username'], $_GET['time'], $_GET['end_time'], $_GET['date'], $_GET['event']);
    }
    
    function newUser($squad, $username, $stime, $etime, $date, $event){
        $host = "127.0.0.1";
        ...
        if($pass1 == $pass2){
		    ...
		    $sql = "INSERT INTO events (user, event, squad, time, end_time, date, accepted ) VALUES ('".$username."', '".$event."', '".$squad."', '".$stime."', '".$etime."', '".$date."', '".$username."+')";
		      if ($connection->query($sql) === TRUE) {
		         echo "<script> window.location='https://squad-sneharams.c9users.io/view_squad.php?username=".$_GET['username']."&squad=".$squad."'</script>";
      				  exit();
		      } else {
...
<html lang="en">
  <head>
    ...
    <title>Squad - Create Event</title>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                  ...
                  <li class="sub-menu">
                      <a class="active" href="create_event.php?username=<?php
                                                                  echo $_GET['username'];
                                                                  ?>">
                          <i class="fa fa-dashboard"></i>
          ...
          <section class="wrapper">
       	  ...
       	  <div class="row">
       	     <div class="col-lg-9 main-chart">
    		      ...
    		      <form  method="get">
    		        <h2 class="form-login-heading">Create Event</h2>
    		        <br><br>
    		        <div>
    		            <!--input Event name instead of username-->
    		            <input name="username" type="text" class="form-control" placeholder="Username" autofocus>
    		            <br>
    		            <!--input Event picture instead of squad-->
    		            <input name="squad" type="text" class="form-control" placeholder="Squad Name" autofocus>
    		            <br>
    		            <!--input number of members (0 to all)-->
    		            <input name="event" type="text" class="form-control" placeholder="Event">
    		            <br>
    		            <!--input time period, for example from 4-5-->
    		            <input name="date" type="text" class="form-control" placeholder="Date (MM/DD/YYYY)">
                        <br>
                        <!--input location name-->
                        <input name="time" type="text" class="form-control" placeholder="Start Time (Military Time)" autofocus>
                        <br>
                        <input name="end_time" type="text" class="form-control" placeholder="End Time (Military Time)" autofocus>
                        <br>
                        <!--input phone number variable for squad members (so user would type in name of squad member)-->
        
                        <br>
                        <!--change this button to submit event button-->
    		            <button class="btn btn-theme btn-block" href="index.php" type="submit"> CREATE EVENT</button>
