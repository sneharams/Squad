    ...
    dataTable.addRows([
      ...
      <?php
                            	...
                            	while ($row = mysqli_fetch_assoc($result)) {
                                  ...
                                  if ($row['date'] == $_GET['date'] && $row['squad'] == $_GET['squad']){
                                      ...
                                      echo "['".$row['event']."', '".$status."', new Date(0, 0,  0,".$starthour.",".$startminute."), new Date(0, 0, 0,".$endhour.",".$endminute.")],";
                                  }
                            	}
