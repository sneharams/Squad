...
<ul class="days"> 
  <li class='col-md-2 col-sm-2 col-md-offset-1 box0'>
                  			<div class='box1'>
					  			<h3> 27</h3>
                  			</div>
					  			<p>No events today</p>
        ...
        $host = "127.0.0.1";
                            ...
                            $port = 3306;                                //The port #. It is always 3306
                            	...
                            	while ($row = mysqli_fetch_assoc($result)) {
                                  ...
                                  if ($row['date'] == '12/'.$i.'/2016' && $row['squad'] == $_GET['squad']){
                                      $num_events++;
                                  }
                            	}
                		  ...
                		  $connection -> close();
                		  if($num_events > 0){
                		       echo " <li  class='col-md-2 col-sm-2 col-md-offset-1 box0'><a href='view_day.php?username=".$_GET['username']."&squad=".$_GET['squad']."&date=12/".$i."/2016'>
                                  			<div  class='box1'>
                					  			<h3 style=\"background-image:url('/assets/css/".$num_events."-color.jpg'); background-size: 100%;\" style='color:#1abc9c;'>".$i."</h3>
                                  			</div>
                					  			<p>".$num_events." Event(s)</p>
                                  	</a>	</li>";
                                        $num_events=0;
                		  } else {
                		      echo  " <li class='col-md-2 col-sm-2 col-md-offset-1 box0'>
                                  			<div class='box1'>
                					  			<h3 style='color:#1abc9c;'>".$i."</h3>
                                  			</div>
                					  			<p>No Events</p>
                                  		</li>";
                		  }
