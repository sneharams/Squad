...
<?php
    if(isset($_GET['username']) && isset($_GET['squad']) && isset($_GET['password'])){
        newUser($_GET['username'], $_GET['squad'], $_GET['password']);
    }
    function newUser($username, $squad, $pass){
        $host = "127.0.0.1";
        ...
        $port = 3306;                                //The port #. It is always 3306
			...
			while ($row = mysqli_fetch_assoc($result)) {
              if ($row['squad'] == $squad){
                $sql = "UPDATE squads SET members='".$row['members']."+".$username."' WHERE squad='".$squad."'";
          ...
          <section class="wrapper">
       	  ...
       	  <div class="row">
       	     <div class="col-lg-9 main-chart">
    		      ...
    		      <form  method="get">
    		        <h2 class="form-login-heading">Join Squad</h2>
    		        <br><br>
    		        <div>
